...
a \times 10^n,
\]
where \(n\) is an integer and usually \(1 \leq |a| < 10\). The number \(a\) carries the significant digits, while \(10^n\) carries the scale.
\end{definitionbox}

\begin{center}
\begin{tabular}{@{}lll@{}}
\toprule
Scientific notation & Decimal form & Comment \\
\midrule
\(2.7\times 10^{17}\) & \(270000000000000000\) & decimal point moves right \\
\(1.602\times 10^{-19}\) & \(0.0000000000000000001602\) & decimal point moves left \\
\(3.00\times 10^8\) & \(300000000\) & order of magnitude \(10^8\) \\
\bottomrule
\end{tabular}
\end{center}
