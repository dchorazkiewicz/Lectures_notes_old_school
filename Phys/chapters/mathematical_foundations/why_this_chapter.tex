...
\begin{summarybox}
This chapter should be read as a compact toolbox. Its goal is not to prove everything, but to make symbols, formulas, graphs, vectors, matrices, derivatives, and integrals easier to recognize and use.
\end{summarybox}
