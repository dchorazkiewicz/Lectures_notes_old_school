...
\begin{tabular}{@{}ll@{}}
\toprule
Operation & Coordinate rule \\
\midrule
Addition & \((1,2)+(3,4)=(4,6)\) \\
Scalar multiplication & \(2(1,3)=(2,6)\) \\
Zero vector in the plane & \(\mathbf{0}=(0,0)\) \\
Zero vector in space & \(\mathbf{0}=(0,0,0)\) \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{summarybox}
For this chapter, remember the basic structure: components, magnitude, addition, scalar multiplication, the zero vector, and the dot product.
\end{summarybox}
