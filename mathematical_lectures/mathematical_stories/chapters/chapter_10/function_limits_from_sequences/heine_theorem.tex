...
A function limit can be tested by following the function along every sequence of inputs approaching the point. This is the natural bridge from the discrete theory of sequences to the local behavior of functions.
