...
Only the forward implication is proved here. The reverse implication uses completeness of the real numbers: a real Cauchy sequence cannot approach a missing point outside $\mathbb R$. We use that completeness result without developing its full construction.
\end{remarkbox}
