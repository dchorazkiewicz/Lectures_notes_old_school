...
a double cone with a plane and vary the inclination of the cutting plane. A plane
perpendicular to the cone axis gives a circle. A tilted plane that meets only one
nappe gives an ellipse. At the limiting inclination, when the plane is parallel to
a generator of the cone, the intersection is a parabola. A steeper plane meeting
both nappes gives a hyperbola.

Thus the four curves are not an arbitrary list. They arise by varying one geometric
requirement while keeping the cone fixed.
