...
\begin{tikzpicture}[scale=0.78]
    \foreach \s/\lab/\ang in {0/circle/0,4.2/ellipse/12,8.4/parabola/28,12.6/hyperbola/65} {
        \begin{scope}[xshift=\s cm]
            \draw[gray!70] (0,0)--(-1.4,2.4);
            \draw[gray!70] (0,0)--(1.4,2.4);
            \draw[gray!70] (0,0)--(-1.4,-2.4);
            \draw[gray!70] (0,0)--(1.4,-2.4);
            \draw[blue!70!black,line width=1.1pt,rotate around={\ang:(0,0.65)}]
                (-1.45,0.65)--(1.45,0.65);
            \node[below] at (0,-2.7) {\lab};
        \end{scope}
    }
\end{tikzpicture}
\end{center}

A nearly horizontal cut gives a circle; an oblique cut through one nappe gives an
ellipse; a cut parallel to a generating side gives a parabola; and a cut meeting
both nappes gives a hyperbola. The changing curve records how one geometric
requirement changes while the cone remains fixed.
