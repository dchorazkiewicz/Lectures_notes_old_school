...
\end{array}
\]
At the axes this gives the familiar values $0$, $1$, and $-1$. For arbitrary
real $t$, define sine and cosine periodically:
\[
\sin(t+2\pi k)=\sin t,
\qquad
\cos(t+2\pi k)=\cos t,
\qquad k\in\mathbb Z.
\]
If $t=m_{\mathrm{rad}}(\alpha)$, then $\cos t$ is the same value as the geometric
cosine $\cos\alpha$. This explains the notation
