...
resulting perpendicular bisector passes through its midpoint $P$, and since
$AB$ lies on $\ell$, it is perpendicular to $\ell$.
...
they meet again at a second point $Q$. By the perpendicular-bisector construction,
the line through the two points equidistant from $A$ and $B$, namely $P$ and $Q$,
is perpendicular to $AB$ and hence to $\ell$.
