...
\begin{tikzpicture}[scale=0.9]
    ...
    \draw[blue!65,dashed,line width=0.9pt] (P) circle (2.2);

    % Step 2: equal circles centred at A and B
    \draw[orange!85!black,dashed,line width=0.9pt] (A) circle (3.25);
    \draw[orange!85!black,dashed,line width=0.9pt] (B) circle (3.25);
