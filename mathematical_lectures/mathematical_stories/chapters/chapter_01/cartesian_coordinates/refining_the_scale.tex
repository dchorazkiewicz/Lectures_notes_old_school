...
This assumption is additional to the finite straightedge-and-compass operations.
Those operations construct many particular positions, including all dyadic
marks, but not every real position. Continuity supplies the complete real scale
used by coordinates. After this step, every point of each axis has a unique
signed real label.