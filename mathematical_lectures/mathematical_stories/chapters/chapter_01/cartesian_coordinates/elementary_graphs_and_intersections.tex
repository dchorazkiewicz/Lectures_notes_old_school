...
\begin{tikzpicture}[x=0.8cm,y=0.8cm,>=Latex]
    ...
    \begin{scope}[shift={(3.2,0)}]
        ...
        \draw[very thick] (0,0) circle (2);
        \node[below] at (0,-2.8) {$x^2+y^2\leq 4$};
        \node at (0,-3.3) {disk};
    \end{scope}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[x=0.72cm,y=0.72cm,>=Latex]
    \begin{scope}[shift={(-4.2,2.6)}]
        ...
        \node[below] at (0,-2.4) {circle};
    \end{scope}
    \begin{scope}[shift={(2.0,2.6)}]
        \draw[->] (-3.2,0) -- (3.2,0);
        \draw[->] (0,-2.2) -- (0,2.2);
        \draw[very thick] (0,0) ellipse (2.6 and 1.6);
        \node[below] at (0,-2.4) {ellipse};
    \end{scope}
    \begin{scope}[shift={(-4.2,-2.5)}]
        ...
        \draw[very thick,domain=-1.25:1.25,samples=100] plot ({-2*cosh(\x)},{sinh(\x)});
        \node[below] at (0,-2.4) {hyperbola};
    \end{scope}
    \begin{scope}[shift={(2.0,-2.5)}]
        \draw[->] (-3.0,0) -- (3.0,0);
        \draw[->] (0,-0.8) -- (0,3.0);
        \draw[very thick,domain=-2.4:2.4,samples=100] plot (\x,{0.5*\x*\x});
        \node[below] at (0,-1.0) {parabola};
    \end{scope}
\end{tikzpicture}
\end{center}
