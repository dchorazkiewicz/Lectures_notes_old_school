...
nonzero. Its solution set is the collection of all points
$(x,y)\in\mathbb{R}^2$ whose coordinates satisfy the equation.
\end{definitionbox}
...
Ax^2+Bxy+Cy^2
\]
form the quadratic part. The remaining terms affect the position and size of
the curve, while the quadratic part largely determines its geometric type.
