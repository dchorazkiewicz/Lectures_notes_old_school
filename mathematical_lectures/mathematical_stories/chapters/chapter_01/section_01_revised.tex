...
lines, perpendicularity, congruent segments, circles, arc length, the
...
The language of angles and angle measure will be made explicit only at the end
of the construction. Until then, perpendicularity is treated as one of the
primitive Euclidean relations already available in the plane.
...
|y_2-y_1|.
\]
Together with the segment $PQ$, these two perpendicular separations form a
Euclidean triangle to which the Pythagorean theorem applies.
...
we introduce angle language explicitly and describe how angle measures can be
calculated.
...
\begin{enumerate}
    \item start with a Euclidean plane and its geometric constructions;
    ...
    \item finally introduce angles as regions determined by pairs of rays;
