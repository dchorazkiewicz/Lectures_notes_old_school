...
\[
\varrho(a,c)=\left|a-\frac12(a+b)\right|=\frac12|a-b|=\frac12|b-a|=\left|b-\frac12(a+b)\right|=\varrho(b,c).
\]

Niech teraz punkt $d=c+x$ będzie też środkiem pary punktów $a,b$. Wówczas

\[
\varrho(a,d)=\frac12|a-b|=|a-d|=\frac12|a-b-2x|,
\]
...
\[
\varrho(b,d)=\frac12|a-b|=|a-b|=\frac12|a-b+2x|,
\]
...
\[
(a-b)^2-4x(a-b)+4x^2=(a-b)^2+4x(a-b)+4x^2,
\]
...
\[
\left|\sum_{i=1}^{m}p_i\right|\leq \sum_{i=1}^{m}|p_i|.
\]
