...
\begin{remarkbox}
Terminology varies between textbooks. The phrases \emph{concave up} and \emph{concave down} are also common. In these notes, \(f''>0\) is called \emph{convex}, and \(f''<0\) is called \emph{concave}.
\end{remarkbox}
...
\item Which convexity terminology is being used?
