...
The final note should be written for a human reader. It should show a clear path
from the problem to the conclusion:
\[
\begin{aligned}
\text{problem}
&\longrightarrow \text{given information}
\longrightarrow \text{goal}
\longrightarrow \text{method} \\
&\longrightarrow \text{justified steps}
\longrightarrow \text{verification}
\longrightarrow \text{conclusion}.
\end{aligned}
\]
