...
\subsection{Progress Matters More Than the Starting Point}

Assessment in the exercise classes focuses primarily on how the student works
throughout the semester. Important evidence includes regular preparation,
active participation, willingness to attempt problems, careful revision of
notes, responsible use of feedback, and the ability to explain increasingly
strong mathematical arguments.
...
public explanation difficult. A weak beginning does not prevent a high final
grade from the exercise classes. What matters is whether the student works
conscientiously, responds to feedback, corrects earlier weaknesses, and
demonstrates substantial development over time.

The exercise-class grade therefore reflects a process of learning, not merely a
snapshot taken at the beginning of the semester. A student who starts with
limited confidence or skill but consistently improves, becomes more independent,
and produces increasingly clear and justified work may finish the exercise
classes with a very good grade.

This principle does not lower the standard of mathematical work. It recognises
that reaching the standard is itself a meaningful achievement. Engagement,
revision, and demonstrated progress show that the student is learning how to
learn, which is one of the central aims of the course.
