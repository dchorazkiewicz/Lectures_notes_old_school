...
\[
\begin{aligned}
\text{LLN} &:\ \text{stability},\\
\text{CLT} &:\ \text{fluctuation shape},\\
\text{confidence interval} &:\ \text{coverage procedure},\\
\text{hypothesis test} &:\ \text{compatibility with a proposed model}.
\end{aligned}
\]
\end{summarybox}
