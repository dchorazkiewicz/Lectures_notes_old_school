...
\begin{theorembox}
For independent identically distributed observations with finite expectation,
the sample mean converges in probability to the population mean:
\[
\overline X_n\xrightarrow{P}\mu.
\]
This statement is called the \textbf{law of large numbers}.
\end{theorembox}
...
When the variance is finite, Chebyshev's inequality gives
\[
