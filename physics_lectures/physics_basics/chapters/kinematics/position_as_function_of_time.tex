...
\begin{figure}[htbp]
\centering
\input{figures/kinematics/position_vector}
\caption{Position vector in a two-dimensional coordinate system.}
\label{fig:kinematics-position-vector}
\end{figure}
...
\begin{figure}[htbp]
\centering
\input{figures/kinematics/position_function_parabola}
\caption{Position vectors at two different times for the motion \(\mathbf{r}(t)=(t,t^2)\).}
\label{fig:kinematics-position-function-parabola}
\end{figure}
