...
\longrightarrow \text{acceleration} \\
&\longrightarrow \text{motion}.
\end{aligned}
\]
...
\begin{aligned}
\text{choose system}
&\longrightarrow \text{identify interactions}
\longrightarrow \text{write forces} \\
&\longrightarrow \text{sum forces}
\longrightarrow \text{find acceleration}.
\end{aligned}
\]
